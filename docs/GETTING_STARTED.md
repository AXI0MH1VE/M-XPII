# Getting Started with Axiom Hive

This guide defines the fastest path to a successful, logic-based outcome using the Axiom Hive framework.

## 1. Prerequisites

- Understanding of the **Zero-Drift Rule** (see `GOVERNANCE.md`).
- A target operational friction point (e.g., a workflow that is slow, expensive, or inconsistent).
- $0 liquid capital (Axiom Hive is optimized for this baseline).

## 2. Core Workflow Initialization
...
- [First Workflow Tutorial](file:///C:/Users/axiom/Evidance%20XPII/docs/TUTORIALS/01-FIRST-WORKFLOW.md): A step-by-step walkthrough of a real task.
- [Workforce Models](file:///C:/Users/axiom/Evidance%20XPII/WORKFORCE_MODELS.md): Deep dive into EAU, LSU, and HIU technical functions.
